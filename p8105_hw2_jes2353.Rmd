...
length(unique(brfss_smart2010$locationabbr))
tail(names(sort(table(Forbes2000$category))), 1)

```

There are 404 unique locations included in the dataset. Every state is represented; there are 51 unique values in the state abbreviation column. 